...
1. Enable the extension: `Preferences > Add-ons > Install from Disk…` → `kimodo_motion_cn.zip`.
...
| Component | License |
|-----------|---------|
| This add-on (`kimodo_motion_cn/*`) | GPL-3.0-or-later |
